...
impl MorseCode for String {
    fn to_morse_code(&self) -> Message {
        ...
        // use with_capacity() because we
        // know how big the Vec needs to be
...
/// Implement a custom Display trait for Pulse
...
/// converts the message into morse code
